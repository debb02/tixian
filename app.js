(() => {
    ...
    return `
      ...
      <main class="transfer-screen">
        <section class="transfer-summary">
          ...
          <div class="transfer-action"><span class="transfer-action-icon"><img class="source-icon" src="assets/generated-icons/friends-transfer.png" alt="好友轉賬圖標"></span><span>轉數到好友戶口</span></div>
        </section>
    ...
    return `
      ...
      <main class="ledger-screen">
        <section class="ledger-hero">
          <span class="ledger-wallet"><img class="source-icon" src="assets/generated-icons/ledger-income.png" alt="收入圖標"></span>
          <b>收入</b>
  ...
  function renderArrival() {
    ...
    if (activeTemplateLabel) activeTemplateLabel.textContent = `B：${templateLabels[template]}`;
  ...
  templateSwitcher.addEventListener("click", (event) => {
    ...
    const templateField = form.elements.namedItem("arrivalTemplate");
    if (templateField) templateField.value = config.arrivalTemplate;
    render();
    persist();
  });
