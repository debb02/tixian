  ...
  function renderA1() {
    ...
    return `
      ...
      <article class="receipt receipt--a1">
        <div class="receipt-mark receipt-mark--source"><img class="source-icon source-icon--fps-a1" src="assets/source-icons/fps-bank-a1.png" alt="轉數快收款圖標"></div>
    ...
    return `
      ...
      <main class="transfer-screen">
        <section class="transfer-summary">
          ...
          <div class="transfer-action"><span class="transfer-action-icon"><img class="source-icon source-icon--friends" src="assets/source-icons/friends-transfer.png" alt="好友轉賬圖標"></span><span>轉數到好友戶口</span></div>
        </section>
    ...
    return `
      ...
      <main class="ledger-screen">
        <section class="ledger-hero">
          <span class="ledger-wallet"><img class="source-icon source-icon--ledger" src="assets/source-icons/ledger-income.png" alt="收入圖標"></span>
          <b>收入</b>
  ...
  function renderA5() {
    ...
    return `
      ...
      <article class="receipt receipt--a5">
        <div class="receipt-mark receipt-mark--source"><img class="source-icon source-icon--fps-a5" src="assets/source-icons/fps-bank-a5.png" alt="轉數快收款圖標"></div>
        <p class="receipt-kicker">${value("arrivalMessage")}-來自<strong>${value("payerName")}</strong></p>
        <h3>+${value("currency")} ${formatMoney(config.amount)}</h3>
        <div class="receipt-rule"></div>
        <dl>
